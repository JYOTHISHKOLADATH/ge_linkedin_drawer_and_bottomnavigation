                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                              flex: 3,
                              child: Container(child: Text('Company',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),)),
                          Expanded(
                              flex: 1,
                              child: Container(child: Text(':',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),textAlign: TextAlign.center,),)),
                          Expanded(
                              flex: 3,
                              child: Container(child: Text('GE Parts',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),textAlign: TextAlign.center,),)),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                              flex: 3,
                              child: Container(child: Text('Barcode',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),)),
                          Expanded(
                              flex: 1,
                              child: Container(child: Text(':',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),textAlign: TextAlign.center,),)),
                          Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                              flex: 3,
                              child: Container(child: Text('Item Name',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),)),
                          Expanded(
                              flex: 1,
                              child: Container(child: Text(':',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),textAlign: TextAlign.center,),)),
                          Expanded(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Column(
                    children: [
                      Icon(Icons.save,size: 35,color: Color(0xffFD0909),),
                      Text('SAVE',style: TextStyle(fontWeight: FontWeight.bold),)
                    ],
                  ),
                  InkWell(
                    onTap: (){Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> NormalStockCountPage()));},
                    child: Column(
                      children: [
                        Icon(Icons.developer_mode_outlined,size: 35,color: Color(0xffFD0909),),
                        Text('NORMAL',style: TextStyle(fontWeight: FontWeight.bold),)
                      ],
                    ),
                  ),InkWell(
                    onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> EditStock()));},
                    child: Column(
                      children: [
                        Icon(Icons.mode,size: 35,color: Color(0xffFD0909),),
                        Text('EDIT',style: TextStyle(fontWeight: FontWeight.bold),)
                      ],
                    ),
                  ),InkWell(
                    onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> ViewSchedule()));},
                    child: Column(
                      children: [
                        Icon(Icons.cancel,size: 35,color: Color(0xffFD0909),),
