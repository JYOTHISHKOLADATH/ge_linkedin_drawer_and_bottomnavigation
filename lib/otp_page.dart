...
class _OtppageState extends State<Otppage> {
  ...
  final SnackBar otpsnack=SnackBar(
    ...
    content: Text('Enter a valid OTP'),duration: Duration(seconds: 3),);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor:  Color(0xff2F4247),elevation: 0,),
      body: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: RichText(
                        text: TextSpan(
                            text: 'Enter the 4 digit code that you recived on your email - ',
                            style: TextStyle(
                                color: Colors.white,
                                fontSize: 20,
                                fontWeight: FontWeight.bold),
